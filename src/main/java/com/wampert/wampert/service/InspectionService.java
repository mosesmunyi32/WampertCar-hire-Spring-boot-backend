...
import com.wampert.wampert.dto.response.AdminInspectionResponse;
import com.wampert.wampert.dto.response.CustomerInspectionResponse;
...
import com.wampert.wampert.exception.BadRequestException;
...
import com.wampert.wampert.repository.InspectionRepository;
...
InspectionService {
    ...
    public AdminInspectionResponse createPreInspection(CreatePreInspectionRequest request) {
        ...
        InspectionEntity inspection = InspectionEntity.builder()
                ...
                .customerResponse(CustomerResponseStatus.PENDING)
    ...
    public CustomerInspectionResponse customerRespondToInspection(String InspectionId, CustomerInspectionRequest request) {
        ...
        if(inspection.getCustomerResponse()  != CustomerResponseStatus.PENDING) {
        ...
        if(request.getCustomerResponse() == CustomerResponseStatus.REJECTED
    ...
    public AdminInspectionResponse adminConfirmForCustomerInspection(String bookingId) {
        ...
        inspection.setCustomerResponse(CustomerResponseStatus.CONFIRMED);
    ...
    public AdminInspectionResponse createPostInspection(CreatePostInspectionRequest request) {
        ...
        if(preInspection.getCustomerResponse() != CustomerResponseStatus.CONFIRMED) {
    ...
    public AdminInspectionResponse adminUpdateInspection(String inspectionId, UpdateInspectionRequest request) {
        ...
        inspection.setCustomerResponse(CustomerResponseStatus.PENDING);
